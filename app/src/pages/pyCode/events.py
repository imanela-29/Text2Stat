...
def nbr_pages():
    global notre_li
    nbr = []
    url1 = 'http://www.ump.ma/fr/events'
...
def liens(number):
    global les_liens
    url2 = 'http://www.ump.ma/fr/events?page=' + number
...
def mainEvent():
    ...
    while inbr <= nombre_pages:
        ...
        for link in links:
            ...
            ar_output = open('ar_event.txt', 'a', encoding='utf-8')
            fr_output = open('fr_event.txt', 'a', encoding='utf-8')
